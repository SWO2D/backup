...
ShellBoxes ERC20 token contract

Flow:
1. Our CTO will deploy the contract minting to his wallet 10000 ShellBoxes Tokens
2. AMJAD will transfer 100 ShellBoxes tokens to each employee
3. Soufiane, our Buisness Developer, will ask to each of the employees to lock the tokens in the contract 
...
Although... hacking a ShellBoxes's hacker contract? Not gonna happen
...
contract ShellBoxesToken is ERC20{
